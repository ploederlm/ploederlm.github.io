...
The second hit was from major psychiatry/psychotherapy organizations in Germany and Switzerland. The text is saved [here](/blogs/chemical_imbalance/Fachorganisationen-Berufsverband-neurologen-und-psychiater-im-netz.org.html). It was written with the support of leading academic psychiatrists and editors are professional organizations of psychiatrists and neurologists in Germany\
...
The website is not available anymore but I saved it [here](/blogs/chemical_imbalance/Depression_Max Planck_Institut.html).
...
Also from January 2020, the information in the text (saved [here](blogs/chemical_imbalance/Goettingen_Lichttherapie.html)) points unambigously to the CI theory.
...
Found in January 2020, the CI theory is obvious in this text, saved [here](/blogs/chemical_imbalance/Bern_Aktuell_Die_zwei Arten_depressiv_zu_sein.html):
